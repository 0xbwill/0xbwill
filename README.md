<h1 align="center">Hey ! I'm Will <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"></h1>
<p align="center">
...
```javascript
const william = {
  code: ["HTML", "JavaScript", "SCSS", "Laravel", "Symfony"],
  askMeAbout: ["Sports", "Boxing", "Tech", "Books", "Bodybuilding"],
  technologies: {
    backEnd: {
      php: ["Laravel"],
    },
    devOps: ["GCP", "DigitalOcean", "Docker"],
    databases: ["MySQL"],
